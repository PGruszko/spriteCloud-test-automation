...
const CheckoutPage = require("../pages2/CheckoutPage");
const CheckoutOverviewPage = require("../pages2/CheckoutOverviewPage");
const CheckoutCompletePage = require("../pages2/CheckoutCompletePage");
...
test.describe.serial("Sauce Demo - Complete Purchase Flow", () => {
  ...
  test("Test 2: Remain logged in and add at least 2 random products to cart", async () => {
    await inventoryPage.validateInventoryVisible();
    selectedProductNames = await inventoryPage.addRandomProductsToCart(
